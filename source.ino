/* 
  ...
  https://create.arduino.cc/cloud/things/4eb7e733-4e92-4aa6-8363-21232378d14b 
...
void checkMedSchedule(void)
{
  if(pill1.isActive())
  {
    ...
    Serial.print("It is time to take Pill 1 now: ");
  ...
  if(pill2.isActive())
  {
    ...
    display.println("");
    display.display(); 
    Serial.print("It is time to take Pill 2 now: ");
  ...
  if(pill3.isActive())
  {
    ...
    display.println("");
    display.display(); 
    Serial.print("It is time to take Pill 3 now: ");
